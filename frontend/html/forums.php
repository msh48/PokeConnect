    ...
    <div class="container my-3">
      ...
      <div class="row">
        <div class="col-12 col-xl-9">
          <h2 class="h4 bg-info mb-0 p-4 rounded-top"><a href="overview-forum-category.html" class="text-white">Forum category</a></h2>
          <table class="table table-striped table-bordered table-responsive">
            ...
            <tbody>
              <tr>
                <td>
                  <h3 class="h5 mb-0"><a href="overview-topics.html" class="text-uppercase">Forum name</a></h3>
          ...
          <h2 class="h4 bg-danger mb-0 p-4 rounded-top"><a href="overview-forum-category.html" class="text-white">Forum category</a></h2>
          <table class="table table-striped table-bordered table-responsive">
            <thead class="thead-light">
              <tr>
                <th scope="col" class="forum-col">Forum</th>
          ...
          <h2 class="h4 bg-warning mb-0 p-4 rounded-top"><a href="overview-forum-category.html" class="text-white">Forum category</a></h2>
